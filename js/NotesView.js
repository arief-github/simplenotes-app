export default class NotesView {
	constructor(
        ...
        <div class="notes-preview">
            ...
            <textarea name="" id="" cols="30" rows="10" class="notes-body">Take Notes...</textarea>
        </div>`;
		...
		[inputTitle, inputBody].forEach((inputFieldNote) => {
			inputFieldNote.addEventListener("blur", () => {
				const updatedTitle =
		...
		// console.log(this._createListItemHTML(300, "Hey", "Teah Mate", new Date()));
			// this.updateNotePreviewVisbility(false);
	}
	...
	updateNoteList(notes) {
		const notesListContainer =
			this.root.querySelector(".notes-list");
	...
	updateNotePreviewVisbility(visible){
